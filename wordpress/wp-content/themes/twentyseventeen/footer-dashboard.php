...
<?php echo ((strpos($_SERVER['REQUEST_URI'], "/cms/wordpress/dashboard-psi/") === 0) || (strpos($_SERVER['REQUEST_URI'], "/cms/wordpress/dashboard-operator/") === 0)) ? "<script src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyDm3wkIZ2fCbok3eNQ_W5IarDxRIb7vuF8&callback=myMap\"></script>": ""; ?>
